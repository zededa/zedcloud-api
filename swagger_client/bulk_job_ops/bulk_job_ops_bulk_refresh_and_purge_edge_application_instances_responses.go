...
// Code gets the status code for the bulk job ops bulk refresh and purge edge application instances o k response
func (o *BulkJobOpsBulkRefreshAndPurgeEdgeApplicationInstancesOK) Code() int {
	return 200
}
...
// Code gets the status code for the bulk job ops bulk refresh and purge edge application instances bad request response
func (o *BulkJobOpsBulkRefreshAndPurgeEdgeApplicationInstancesBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the bulk job ops bulk refresh and purge edge application instances unauthorized response
func (o *BulkJobOpsBulkRefreshAndPurgeEdgeApplicationInstancesUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the bulk job ops bulk refresh and purge edge application instances forbidden response
func (o *BulkJobOpsBulkRefreshAndPurgeEdgeApplicationInstancesForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the bulk job ops bulk refresh and purge edge application instances not found response
func (o *BulkJobOpsBulkRefreshAndPurgeEdgeApplicationInstancesNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the bulk job ops bulk refresh and purge edge application instances conflict response
func (o *BulkJobOpsBulkRefreshAndPurgeEdgeApplicationInstancesConflict) Code() int {
	return 409
}
...
// Code gets the status code for the bulk job ops bulk refresh and purge edge application instances internal server error response
func (o *BulkJobOpsBulkRefreshAndPurgeEdgeApplicationInstancesInternalServerError) Code() int {
	return 500
}
...
// Code gets the status code for the bulk job ops bulk refresh and purge edge application instances gateway timeout response
func (o *BulkJobOpsBulkRefreshAndPurgeEdgeApplicationInstancesGatewayTimeout) Code() int {
	return 504
}
