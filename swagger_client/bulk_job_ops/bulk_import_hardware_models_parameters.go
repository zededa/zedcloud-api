...
// NewBulkImportHardwareModelsParams creates a new BulkImportHardwareModelsParams object,
...
func NewBulkImportHardwareModelsParams() *BulkImportHardwareModelsParams {
	return &BulkImportHardwareModelsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewBulkImportHardwareModelsParamsWithTimeout creates a new BulkImportHardwareModelsParams object
...
// NewBulkImportHardwareModelsParamsWithContext creates a new BulkImportHardwareModelsParams object
...
// NewBulkImportHardwareModelsParamsWithHTTPClient creates a new BulkImportHardwareModelsParams object
...
func (o *BulkImportHardwareModelsParams) WithDefaults() *BulkImportHardwareModelsParams {
	o.SetDefaults()
	return o
}
...
func (o *BulkImportHardwareModelsParams) WithTimeout(timeout time.Duration) *BulkImportHardwareModelsParams {
...
func (o *BulkImportHardwareModelsParams) WithContext(ctx context.Context) *BulkImportHardwareModelsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *BulkImportHardwareModelsParams) WithHTTPClient(client *http.Client) *BulkImportHardwareModelsParams {
...
func (o *BulkImportHardwareModelsParams) WithXRequestID(xRequestID *string) *BulkImportHardwareModelsParams {
...
func (o *BulkImportHardwareModelsParams) WithBody(body *swagger_models.BulkConfig) *BulkImportHardwareModelsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the bulk import hardware models params
func (o *BulkImportHardwareModelsParams) SetBody(body *swagger_models.BulkConfig) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *BulkImportHardwareModelsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
