...
// NewBulkImportEdgeApplicationsParams creates a new BulkImportEdgeApplicationsParams object,
...
func NewBulkImportEdgeApplicationsParams() *BulkImportEdgeApplicationsParams {
	return &BulkImportEdgeApplicationsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewBulkImportEdgeApplicationsParamsWithTimeout creates a new BulkImportEdgeApplicationsParams object
...
// NewBulkImportEdgeApplicationsParamsWithContext creates a new BulkImportEdgeApplicationsParams object
...
// NewBulkImportEdgeApplicationsParamsWithHTTPClient creates a new BulkImportEdgeApplicationsParams object
...
func (o *BulkImportEdgeApplicationsParams) WithDefaults() *BulkImportEdgeApplicationsParams {
	o.SetDefaults()
	return o
}
...
func (o *BulkImportEdgeApplicationsParams) WithTimeout(timeout time.Duration) *BulkImportEdgeApplicationsParams {
...
func (o *BulkImportEdgeApplicationsParams) WithContext(ctx context.Context) *BulkImportEdgeApplicationsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the bulk import edge applications params
func (o *BulkImportEdgeApplicationsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the bulk import edge applications params
func (o *BulkImportEdgeApplicationsParams) WithHTTPClient(client *http.Client) *BulkImportEdgeApplicationsParams {
...
func (o *BulkImportEdgeApplicationsParams) WithXRequestID(xRequestID *string) *BulkImportEdgeApplicationsParams {
...
func (o *BulkImportEdgeApplicationsParams) WithBody(body *swagger_models.BulkConfig) *BulkImportEdgeApplicationsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the bulk import edge applications params
func (o *BulkImportEdgeApplicationsParams) SetBody(body *swagger_models.BulkConfig) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *BulkImportEdgeApplicationsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
