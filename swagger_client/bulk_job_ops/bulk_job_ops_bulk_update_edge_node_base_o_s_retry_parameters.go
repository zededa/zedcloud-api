...
// NewBulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams creates a new BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams object,
...
func NewBulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams() *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams {
	return &BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewBulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParamsWithTimeout creates a new BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams object
...
// NewBulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParamsWithContext creates a new BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams object
...
// NewBulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParamsWithHTTPClient creates a new BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams object
...
func (o *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams) WithDefaults() *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the bulk job ops bulk update edge node base o s retry params
func (o *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams) WithTimeout(timeout time.Duration) *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the bulk job ops bulk update edge node base o s retry params
func (o *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the bulk job ops bulk update edge node base o s retry params
func (o *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams) WithContext(ctx context.Context) *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the bulk job ops bulk update edge node base o s retry params
func (o *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the bulk job ops bulk update edge node base o s retry params
func (o *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams) WithHTTPClient(client *http.Client) *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams {
...
func (o *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams) WithXRequestID(xRequestID *string) *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams {
...
func (o *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams) WithBody(body *swagger_models.BulkConfig) *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the bulk job ops bulk update edge node base o s retry params
func (o *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams) SetBody(body *swagger_models.BulkConfig) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
