...
// NewBulkCreateEdgeApplicationInstancesParams creates a new BulkCreateEdgeApplicationInstancesParams object,
...
func NewBulkCreateEdgeApplicationInstancesParams() *BulkCreateEdgeApplicationInstancesParams {
	return &BulkCreateEdgeApplicationInstancesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewBulkCreateEdgeApplicationInstancesParamsWithTimeout creates a new BulkCreateEdgeApplicationInstancesParams object
...
// NewBulkCreateEdgeApplicationInstancesParamsWithContext creates a new BulkCreateEdgeApplicationInstancesParams object
...
// NewBulkCreateEdgeApplicationInstancesParamsWithHTTPClient creates a new BulkCreateEdgeApplicationInstancesParams object
...
func (o *BulkCreateEdgeApplicationInstancesParams) WithDefaults() *BulkCreateEdgeApplicationInstancesParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *BulkCreateEdgeApplicationInstancesParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the bulk create edge application instances params
func (o *BulkCreateEdgeApplicationInstancesParams) WithTimeout(timeout time.Duration) *BulkCreateEdgeApplicationInstancesParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the bulk create edge application instances params
func (o *BulkCreateEdgeApplicationInstancesParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the bulk create edge application instances params
func (o *BulkCreateEdgeApplicationInstancesParams) WithContext(ctx context.Context) *BulkCreateEdgeApplicationInstancesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the bulk create edge application instances params
func (o *BulkCreateEdgeApplicationInstancesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the bulk create edge application instances params
func (o *BulkCreateEdgeApplicationInstancesParams) WithHTTPClient(client *http.Client) *BulkCreateEdgeApplicationInstancesParams {
...
func (o *BulkCreateEdgeApplicationInstancesParams) WithXRequestID(xRequestID *string) *BulkCreateEdgeApplicationInstancesParams {
...
func (o *BulkCreateEdgeApplicationInstancesParams) WithBody(body *swagger_models.BulkConfig) *BulkCreateEdgeApplicationInstancesParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the bulk create edge application instances params
func (o *BulkCreateEdgeApplicationInstancesParams) SetBody(body *swagger_models.BulkConfig) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *BulkCreateEdgeApplicationInstancesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
