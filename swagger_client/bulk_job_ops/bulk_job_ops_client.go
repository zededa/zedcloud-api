...
*/
func (a *Client) BulkJobOpsBulkUpdateEdgeNodeBaseOSRetry(params *BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewBulkJobOpsBulkUpdateEdgeNodeBaseOSRetryParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "BulkJobOps_BulkUpdateEdgeNodeBaseOSRetry",
		Method:             "PUT",
		PathPattern:        "/v1/jobs/devices/baseos/upgrade/retry",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*BulkJobOpsBulkUpdateEdgeNodeBaseOSRetryDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
