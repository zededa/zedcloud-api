...
// bindParamIdentityAccessManagementQueryRealms binds the parameter filter.projectid
func (o *IdentityAccessManagementQueryRealmsParams) bindParamFilterProjectid(formats strfmt.Registry) []string {
