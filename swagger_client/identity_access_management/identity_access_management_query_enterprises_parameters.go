...
// bindParamIdentityAccessManagementQueryEnterprises binds the parameter filter.projectid
func (o *IdentityAccessManagementQueryEnterprisesParams) bindParamFilterProjectid(formats strfmt.Registry) []string {
