...
func (o *EdgeNetworkInstanceConfigurationCreateEdgeNetworkInstanceParams) WithBody(body *swagger_models.NetInstConfig) *EdgeNetworkInstanceConfigurationCreateEdgeNetworkInstanceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the edge network instance configuration create edge network instance params
func (o *EdgeNetworkInstanceConfigurationCreateEdgeNetworkInstanceParams) SetBody(body *swagger_models.NetInstConfig) {
	o.Body = body
}
