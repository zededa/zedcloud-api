...
// NewDatastoreConfigurationUpdateDatastoreParams creates a new DatastoreConfigurationUpdateDatastoreParams object,
...
func (o *DatastoreConfigurationUpdateDatastoreParams) WithBody(body DatastoreConfigurationUpdateDatastoreBody) *DatastoreConfigurationUpdateDatastoreParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the datastore configuration update datastore params
func (o *DatastoreConfigurationUpdateDatastoreParams) SetBody(body DatastoreConfigurationUpdateDatastoreBody) {
	o.Body = body
}
