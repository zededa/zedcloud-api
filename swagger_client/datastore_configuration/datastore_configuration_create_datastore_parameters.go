...
// NewDatastoreConfigurationCreateDatastoreParams creates a new DatastoreConfigurationCreateDatastoreParams object,
...
func (o *DatastoreConfigurationCreateDatastoreParams) WithBody(body *swagger_models.DatastoreInfo) *DatastoreConfigurationCreateDatastoreParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the datastore configuration create datastore params
func (o *DatastoreConfigurationCreateDatastoreParams) SetBody(body *swagger_models.DatastoreInfo) {
	o.Body = body
}
