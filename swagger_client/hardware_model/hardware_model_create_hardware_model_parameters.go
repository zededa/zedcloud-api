...
func (o *HardwareModelCreateHardwareModelParams) WithBody(body *swagger_models.SysModel) *HardwareModelCreateHardwareModelParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the hardware model create hardware model params
func (o *HardwareModelCreateHardwareModelParams) SetBody(body *swagger_models.SysModel) {
	o.Body = body
}
