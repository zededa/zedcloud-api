...
// Code gets the status code for the hardware model get global hardware model by name o k response
func (o *HardwareModelGetGlobalHardwareModelByNameOK) Code() int {
	return 200
}
...
// Code gets the status code for the hardware model get global hardware model by name unauthorized response
func (o *HardwareModelGetGlobalHardwareModelByNameUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the hardware model get global hardware model by name forbidden response
func (o *HardwareModelGetGlobalHardwareModelByNameForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the hardware model get global hardware model by name not found response
func (o *HardwareModelGetGlobalHardwareModelByNameNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the hardware model get global hardware model by name internal server error response
func (o *HardwareModelGetGlobalHardwareModelByNameInternalServerError) Code() int {
	return 500
}
...
// Code gets the status code for the hardware model get global hardware model by name gateway timeout response
func (o *HardwareModelGetGlobalHardwareModelByNameGatewayTimeout) Code() int {
	return 504
}
