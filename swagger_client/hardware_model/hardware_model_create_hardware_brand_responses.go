...
// Code gets the status code for the hardware model create hardware brand o k response
func (o *HardwareModelCreateHardwareBrandOK) Code() int {
	return 200
}
...
// Code gets the status code for the hardware model create hardware brand bad request response
func (o *HardwareModelCreateHardwareBrandBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the hardware model create hardware brand unauthorized response
func (o *HardwareModelCreateHardwareBrandUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the hardware model create hardware brand forbidden response
func (o *HardwareModelCreateHardwareBrandForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the hardware model create hardware brand conflict response
func (o *HardwareModelCreateHardwareBrandConflict) Code() int {
	return 409
}
...
// Code gets the status code for the hardware model create hardware brand internal server error response
func (o *HardwareModelCreateHardwareBrandInternalServerError) Code() int {
	return 500
}
...
// Code gets the status code for the hardware model create hardware brand gateway timeout response
func (o *HardwareModelCreateHardwareBrandGatewayTimeout) Code() int {
	return 504
}
