...
func (o *HardwareModelUpdateHardwareModelParams) WithBody(body HardwareModelUpdateHardwareModelBody) *HardwareModelUpdateHardwareModelParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the hardware model update hardware model params
func (o *HardwareModelUpdateHardwareModelParams) SetBody(body HardwareModelUpdateHardwareModelBody) {
	o.Body = body
}
