...
func (o *EdgeApplicationInstanceConfigurationCreateEdgeApplicationInstanceParams) WithBody(body *swagger_models.AppInstance) *EdgeApplicationInstanceConfigurationCreateEdgeApplicationInstanceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the edge application instance configuration create edge application instance params
func (o *EdgeApplicationInstanceConfigurationCreateEdgeApplicationInstanceParams) SetBody(body *swagger_models.AppInstance) {
	o.Body = body
}
