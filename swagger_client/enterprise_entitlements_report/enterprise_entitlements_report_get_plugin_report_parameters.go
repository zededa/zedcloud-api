...
// NewEnterpriseEntitlementsReportGetPluginReportParams creates a new EnterpriseEntitlementsReportGetPluginReportParams object,
...
func NewEnterpriseEntitlementsReportGetPluginReportParams() *EnterpriseEntitlementsReportGetPluginReportParams {
	return &EnterpriseEntitlementsReportGetPluginReportParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewEnterpriseEntitlementsReportGetPluginReportParamsWithTimeout creates a new EnterpriseEntitlementsReportGetPluginReportParams object
...
// NewEnterpriseEntitlementsReportGetPluginReportParamsWithContext creates a new EnterpriseEntitlementsReportGetPluginReportParams object
...
// NewEnterpriseEntitlementsReportGetPluginReportParamsWithHTTPClient creates a new EnterpriseEntitlementsReportGetPluginReportParams object
...
func (o *EnterpriseEntitlementsReportGetPluginReportParams) WithDefaults() *EnterpriseEntitlementsReportGetPluginReportParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *EnterpriseEntitlementsReportGetPluginReportParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the enterprise entitlements report get plugin report params
func (o *EnterpriseEntitlementsReportGetPluginReportParams) WithTimeout(timeout time.Duration) *EnterpriseEntitlementsReportGetPluginReportParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the enterprise entitlements report get plugin report params
func (o *EnterpriseEntitlementsReportGetPluginReportParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the enterprise entitlements report get plugin report params
func (o *EnterpriseEntitlementsReportGetPluginReportParams) WithContext(ctx context.Context) *EnterpriseEntitlementsReportGetPluginReportParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the enterprise entitlements report get plugin report params
func (o *EnterpriseEntitlementsReportGetPluginReportParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the enterprise entitlements report get plugin report params
func (o *EnterpriseEntitlementsReportGetPluginReportParams) WithHTTPClient(client *http.Client) *EnterpriseEntitlementsReportGetPluginReportParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the enterprise entitlements report get plugin report params
func (o *EnterpriseEntitlementsReportGetPluginReportParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithXRequestID adds the xRequestID to the enterprise entitlements report get plugin report params
func (o *EnterpriseEntitlementsReportGetPluginReportParams) WithXRequestID(xRequestID *string) *EnterpriseEntitlementsReportGetPluginReportParams {
...
func (o *EnterpriseEntitlementsReportGetPluginReportParams) WithTenantID(tenantID *string) *EnterpriseEntitlementsReportGetPluginReportParams {
	o.SetTenantID(tenantID)
	return o
}

// SetTenantID adds the tenantId to the enterprise entitlements report get plugin report params
func (o *EnterpriseEntitlementsReportGetPluginReportParams) SetTenantID(tenantID *string) {
	o.TenantID = tenantID
}

// WriteToRequest writes these params to a swagger request
func (o *EnterpriseEntitlementsReportGetPluginReportParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
