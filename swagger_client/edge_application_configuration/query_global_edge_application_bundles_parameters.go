...
// NewQueryGlobalEdgeApplicationBundlesParams creates a new QueryGlobalEdgeApplicationBundlesParams object,
...
func NewQueryGlobalEdgeApplicationBundlesParams() *QueryGlobalEdgeApplicationBundlesParams {
	return &QueryGlobalEdgeApplicationBundlesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewQueryGlobalEdgeApplicationBundlesParamsWithTimeout creates a new QueryGlobalEdgeApplicationBundlesParams object
...
// NewQueryGlobalEdgeApplicationBundlesParamsWithContext creates a new QueryGlobalEdgeApplicationBundlesParams object
...
// NewQueryGlobalEdgeApplicationBundlesParamsWithHTTPClient creates a new QueryGlobalEdgeApplicationBundlesParams object
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithDefaults() *QueryGlobalEdgeApplicationBundlesParams {
	o.SetDefaults()
	return o
}
...
func (o *QueryGlobalEdgeApplicationBundlesParams) SetDefaults() {
	...
	val := QueryGlobalEdgeApplicationBundlesParams{
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithTimeout(timeout time.Duration) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithContext(ctx context.Context) *QueryGlobalEdgeApplicationBundlesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the query global edge application bundles params
func (o *QueryGlobalEdgeApplicationBundlesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the query global edge application bundles params
func (o *QueryGlobalEdgeApplicationBundlesParams) WithHTTPClient(client *http.Client) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithXRequestID(xRequestID *string) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithFilterAppType(filterAppType *string) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithFilterCategory(filterCategory *string) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithFilterOriginType(filterOriginType *string) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithNextOrderBy(nextOrderBy *string) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithNextPageNum(nextPageNum *int64) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithNextPageSize(nextPageSize *int64) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithNextPageToken(nextPageToken *string) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithNextTotalPages(nextTotalPages *int64) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WithSummary(summary *bool) *QueryGlobalEdgeApplicationBundlesParams {
...
func (o *QueryGlobalEdgeApplicationBundlesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
