...
// NewEdgeApplicationConfigurationCreateEdgeApplicationBundleParams creates a new EdgeApplicationConfigurationCreateEdgeApplicationBundleParams object,
...
func (o *EdgeApplicationConfigurationCreateEdgeApplicationBundleParams) WithBody(body *swagger_models.App) *EdgeApplicationConfigurationCreateEdgeApplicationBundleParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the edge application configuration create edge application bundle params
func (o *EdgeApplicationConfigurationCreateEdgeApplicationBundleParams) SetBody(body *swagger_models.App) {
	o.Body = body
}
