...
// NewGetGlobalEdgeApplicationBundleParams creates a new GetGlobalEdgeApplicationBundleParams object,
...
func NewGetGlobalEdgeApplicationBundleParams() *GetGlobalEdgeApplicationBundleParams {
	return &GetGlobalEdgeApplicationBundleParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetGlobalEdgeApplicationBundleParamsWithTimeout creates a new GetGlobalEdgeApplicationBundleParams object
...
// NewGetGlobalEdgeApplicationBundleParamsWithContext creates a new GetGlobalEdgeApplicationBundleParams object
...
// NewGetGlobalEdgeApplicationBundleParamsWithHTTPClient creates a new GetGlobalEdgeApplicationBundleParams object
...
func (o *GetGlobalEdgeApplicationBundleParams) WithDefaults() *GetGlobalEdgeApplicationBundleParams {
	o.SetDefaults()
	return o
}
...
func (o *GetGlobalEdgeApplicationBundleParams) WithTimeout(timeout time.Duration) *GetGlobalEdgeApplicationBundleParams {
...
func (o *GetGlobalEdgeApplicationBundleParams) WithContext(ctx context.Context) *GetGlobalEdgeApplicationBundleParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get global edge application bundle params
func (o *GetGlobalEdgeApplicationBundleParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get global edge application bundle params
func (o *GetGlobalEdgeApplicationBundleParams) WithHTTPClient(client *http.Client) *GetGlobalEdgeApplicationBundleParams {
...
func (o *GetGlobalEdgeApplicationBundleParams) WithXRequestID(xRequestID *string) *GetGlobalEdgeApplicationBundleParams {
...
func (o *GetGlobalEdgeApplicationBundleParams) WithID(id string) *GetGlobalEdgeApplicationBundleParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get global edge application bundle params
func (o *GetGlobalEdgeApplicationBundleParams) SetID(id string) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *GetGlobalEdgeApplicationBundleParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
