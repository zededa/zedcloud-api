...
// Code gets the status code for the edge node status get edge node raw status by name o k response
func (o *EdgeNodeStatusGetEdgeNodeRawStatusByNameOK) Code() int {
	return 200
}
...
// Code gets the status code for the edge node status get edge node raw status by name unauthorized response
func (o *EdgeNodeStatusGetEdgeNodeRawStatusByNameUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the edge node status get edge node raw status by name forbidden response
func (o *EdgeNodeStatusGetEdgeNodeRawStatusByNameForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the edge node status get edge node raw status by name not found response
func (o *EdgeNodeStatusGetEdgeNodeRawStatusByNameNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the edge node status get edge node raw status by name internal server error response
func (o *EdgeNodeStatusGetEdgeNodeRawStatusByNameInternalServerError) Code() int {
	return 500
}
...
// Code gets the status code for the edge node status get edge node raw status by name gateway timeout response
func (o *EdgeNodeStatusGetEdgeNodeRawStatusByNameGatewayTimeout) Code() int {
	return 504
}
