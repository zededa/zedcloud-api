...
// NewGetResourceGroupStatusByIDParams creates a new GetResourceGroupStatusByIDParams object,
...
func NewGetResourceGroupStatusByIDParams() *GetResourceGroupStatusByIDParams {
	return &GetResourceGroupStatusByIDParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetResourceGroupStatusByIDParamsWithTimeout creates a new GetResourceGroupStatusByIDParams object
...
// NewGetResourceGroupStatusByIDParamsWithContext creates a new GetResourceGroupStatusByIDParams object
...
// NewGetResourceGroupStatusByIDParamsWithHTTPClient creates a new GetResourceGroupStatusByIDParams object
...
func (o *GetResourceGroupStatusByIDParams) WithDefaults() *GetResourceGroupStatusByIDParams {
	o.SetDefaults()
	return o
}
...
func (o *GetResourceGroupStatusByIDParams) WithTimeout(timeout time.Duration) *GetResourceGroupStatusByIDParams {
...
func (o *GetResourceGroupStatusByIDParams) WithContext(ctx context.Context) *GetResourceGroupStatusByIDParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get resource group status by Id params
func (o *GetResourceGroupStatusByIDParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get resource group status by Id params
func (o *GetResourceGroupStatusByIDParams) WithHTTPClient(client *http.Client) *GetResourceGroupStatusByIDParams {
...
func (o *GetResourceGroupStatusByIDParams) WithXRequestID(xRequestID *string) *GetResourceGroupStatusByIDParams {
...
func (o *GetResourceGroupStatusByIDParams) WithID(id string) *GetResourceGroupStatusByIDParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get resource group status by Id params
func (o *GetResourceGroupStatusByIDParams) SetID(id string) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *GetResourceGroupStatusByIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
