...
func (o *GetEdgeApplicationInstanceEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetEdgeApplicationInstanceEventsOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewGetEdgeApplicationInstanceEventsUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 403:
		result := NewGetEdgeApplicationInstanceEventsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 404:
		result := NewGetEdgeApplicationInstanceEventsNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		result := NewGetEdgeApplicationInstanceEventsInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 504:
		result := NewGetEdgeApplicationInstanceEventsGatewayTimeout()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetEdgeApplicationInstanceEventsOK() *GetEdgeApplicationInstanceEventsOK {
	return &GetEdgeApplicationInstanceEventsOK{}
}
...
func (o *GetEdgeApplicationInstanceEventsOK) Error() string {
	return fmt.Sprintf("[GET /v1/apps/instances/id/{objid}/events][%d] getEdgeApplicationInstanceEventsOK  %+v", 200, o.Payload)
}
func (o *GetEdgeApplicationInstanceEventsOK) GetPayload() *swagger_models.EventQueryResponse {
	return o.Payload
}

func (o *GetEdgeApplicationInstanceEventsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetEdgeApplicationInstanceEventsUnauthorized() *GetEdgeApplicationInstanceEventsUnauthorized {
	return &GetEdgeApplicationInstanceEventsUnauthorized{}
}
...
func (o *GetEdgeApplicationInstanceEventsUnauthorized) Error() string {
	return fmt.Sprintf("[GET /v1/apps/instances/id/{objid}/events][%d] getEdgeApplicationInstanceEventsUnauthorized  %+v", 401, o.Payload)
}
func (o *GetEdgeApplicationInstanceEventsUnauthorized) GetPayload() *swagger_models.ZsrvResponse {
	return o.Payload
}

func (o *GetEdgeApplicationInstanceEventsUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetEdgeApplicationInstanceEventsForbidden() *GetEdgeApplicationInstanceEventsForbidden {
	return &GetEdgeApplicationInstanceEventsForbidden{}
}
...
func (o *GetEdgeApplicationInstanceEventsForbidden) Error() string {
	return fmt.Sprintf("[GET /v1/apps/instances/id/{objid}/events][%d] getEdgeApplicationInstanceEventsForbidden  %+v", 403, o.Payload)
}
func (o *GetEdgeApplicationInstanceEventsForbidden) GetPayload() *swagger_models.ZsrvResponse {
	return o.Payload
}

func (o *GetEdgeApplicationInstanceEventsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetEdgeApplicationInstanceEventsNotFound() *GetEdgeApplicationInstanceEventsNotFound {
	return &GetEdgeApplicationInstanceEventsNotFound{}
}
...
func (o *GetEdgeApplicationInstanceEventsNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/apps/instances/id/{objid}/events][%d] getEdgeApplicationInstanceEventsNotFound  %+v", 404, o.Payload)
}
func (o *GetEdgeApplicationInstanceEventsNotFound) GetPayload() *swagger_models.ZsrvResponse {
	return o.Payload
}

func (o *GetEdgeApplicationInstanceEventsNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetEdgeApplicationInstanceEventsInternalServerError() *GetEdgeApplicationInstanceEventsInternalServerError {
	return &GetEdgeApplicationInstanceEventsInternalServerError{}
}
...
func (o *GetEdgeApplicationInstanceEventsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /v1/apps/instances/id/{objid}/events][%d] getEdgeApplicationInstanceEventsInternalServerError  %+v", 500, o.Payload)
}
func (o *GetEdgeApplicationInstanceEventsInternalServerError) GetPayload() *swagger_models.ZsrvResponse {
	return o.Payload
}

func (o *GetEdgeApplicationInstanceEventsInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetEdgeApplicationInstanceEventsGatewayTimeout() *GetEdgeApplicationInstanceEventsGatewayTimeout {
	return &GetEdgeApplicationInstanceEventsGatewayTimeout{}
}
...
func (o *GetEdgeApplicationInstanceEventsGatewayTimeout) Error() string {
	return fmt.Sprintf("[GET /v1/apps/instances/id/{objid}/events][%d] getEdgeApplicationInstanceEventsGatewayTimeout  %+v", 504, o.Payload)
}
func (o *GetEdgeApplicationInstanceEventsGatewayTimeout) GetPayload() *swagger_models.ZsrvResponse {
	return o.Payload
}

func (o *GetEdgeApplicationInstanceEventsGatewayTimeout) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
