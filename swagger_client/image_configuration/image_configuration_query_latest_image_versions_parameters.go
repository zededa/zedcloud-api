...
// NewImageConfigurationQueryLatestImageVersionsParams creates a new ImageConfigurationQueryLatestImageVersionsParams object,
...
func NewImageConfigurationQueryLatestImageVersionsParams() *ImageConfigurationQueryLatestImageVersionsParams {
	return &ImageConfigurationQueryLatestImageVersionsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewImageConfigurationQueryLatestImageVersionsParamsWithTimeout creates a new ImageConfigurationQueryLatestImageVersionsParams object
...
// NewImageConfigurationQueryLatestImageVersionsParamsWithContext creates a new ImageConfigurationQueryLatestImageVersionsParams object
...
// NewImageConfigurationQueryLatestImageVersionsParamsWithHTTPClient creates a new ImageConfigurationQueryLatestImageVersionsParams object
...
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithDefaults() *ImageConfigurationQueryLatestImageVersionsParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *ImageConfigurationQueryLatestImageVersionsParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the image configuration query latest image versions params
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithTimeout(timeout time.Duration) *ImageConfigurationQueryLatestImageVersionsParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the image configuration query latest image versions params
func (o *ImageConfigurationQueryLatestImageVersionsParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the image configuration query latest image versions params
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithContext(ctx context.Context) *ImageConfigurationQueryLatestImageVersionsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the image configuration query latest image versions params
func (o *ImageConfigurationQueryLatestImageVersionsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the image configuration query latest image versions params
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithHTTPClient(client *http.Client) *ImageConfigurationQueryLatestImageVersionsParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the image configuration query latest image versions params
func (o *ImageConfigurationQueryLatestImageVersionsParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithXRequestID adds the xRequestID to the image configuration query latest image versions params
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithXRequestID(xRequestID *string) *ImageConfigurationQueryLatestImageVersionsParams {
...
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithFields(fields []string) *ImageConfigurationQueryLatestImageVersionsParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the image configuration query latest image versions params
func (o *ImageConfigurationQueryLatestImageVersionsParams) SetFields(fields []string) {
	o.Fields = fields
}

// WithFilterNamePattern adds the filterNamePattern to the image configuration query latest image versions params
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithFilterNamePattern(filterNamePattern *string) *ImageConfigurationQueryLatestImageVersionsParams {
...
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithNextOrderBy(nextOrderBy []string) *ImageConfigurationQueryLatestImageVersionsParams {
...
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithNextPageNum(nextPageNum *int64) *ImageConfigurationQueryLatestImageVersionsParams {
...
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithNextPageSize(nextPageSize *int64) *ImageConfigurationQueryLatestImageVersionsParams {
...
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithNextPageToken(nextPageToken *string) *ImageConfigurationQueryLatestImageVersionsParams {
...
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithNextTotalPages(nextTotalPages *int64) *ImageConfigurationQueryLatestImageVersionsParams {
...
func (o *ImageConfigurationQueryLatestImageVersionsParams) WithSummary(summary *bool) *ImageConfigurationQueryLatestImageVersionsParams {
	o.SetSummary(summary)
	return o
}

// SetSummary adds the summary to the image configuration query latest image versions params
func (o *ImageConfigurationQueryLatestImageVersionsParams) SetSummary(summary *bool) {
	o.Summary = summary
}

// WriteToRequest writes these params to a swagger request
func (o *ImageConfigurationQueryLatestImageVersionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
...
// bindParamImageConfigurationQueryLatestImageVersions binds the parameter fields
func (o *ImageConfigurationQueryLatestImageVersionsParams) bindParamFields(formats strfmt.Registry) []string {
	fieldsIR := o.Fields
...
// bindParamImageConfigurationQueryLatestImageVersions binds the parameter next.orderBy
func (o *ImageConfigurationQueryLatestImageVersionsParams) bindParamNextOrderBy(formats strfmt.Registry) []string {
