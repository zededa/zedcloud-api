...
func (o *ImageConfigurationMarkEveImageLatestParams) WithBody(body *swagger_models.ImageConfig) *ImageConfigurationMarkEveImageLatestParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the image configuration mark eve image latest params
func (o *ImageConfigurationMarkEveImageLatestParams) SetBody(body *swagger_models.ImageConfig) {
	o.Body = body
}
