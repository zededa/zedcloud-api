...
// NewImageConfigurationCreateImageParams creates a new ImageConfigurationCreateImageParams object,
...
func (o *ImageConfigurationCreateImageParams) WithBody(body *swagger_models.ImageConfig) *ImageConfigurationCreateImageParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the image configuration create image params
func (o *ImageConfigurationCreateImageParams) SetBody(body *swagger_models.ImageConfig) {
	o.Body = body
}
