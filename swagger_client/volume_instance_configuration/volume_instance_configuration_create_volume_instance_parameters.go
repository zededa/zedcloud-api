...
// NewVolumeInstanceConfigurationCreateVolumeInstanceParams creates a new VolumeInstanceConfigurationCreateVolumeInstanceParams object,
...
func (o *VolumeInstanceConfigurationCreateVolumeInstanceParams) WithBody(body *swagger_models.VolInstConfig) *VolumeInstanceConfigurationCreateVolumeInstanceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the volume instance configuration create volume instance params
func (o *VolumeInstanceConfigurationCreateVolumeInstanceParams) SetBody(body *swagger_models.VolInstConfig) {
	o.Body = body
}
