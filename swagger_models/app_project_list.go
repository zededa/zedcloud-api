...
func (m *AppProjectList) validateNext(formats strfmt.Registry) error {
...
func (m *AppProjectList) validateProjectDetails(formats strfmt.Registry) error {
...
func (m *AppProjectList) contextValidateNext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppProjectList) contextValidateProjectDetails(ctx context.Context, formats strfmt.Registry) error {
