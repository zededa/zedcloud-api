...
func (m *AppInstances) validateList(formats strfmt.Registry) error {
...
func (m *AppInstances) validateNext(formats strfmt.Registry) error {
...
func (m *AppInstances) validateSummaryByState(formats strfmt.Registry) error {
...
func (m *AppInstances) contextValidateList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppInstances) contextValidateNext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppInstances) contextValidateSummaryByState(ctx context.Context, formats strfmt.Registry) error {
