...
func (m *AAAFailureTokenRefresh) validateCause(formats strfmt.Registry) error {
...
func (m *AAAFailureTokenRefresh) validateOriginal(formats strfmt.Registry) error {
...
func (m *AAAFailureTokenRefresh) contextValidateCause(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AAAFailureTokenRefresh) contextValidateOriginal(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AAAFailureTokenRefresh) UnmarshalBinary(b []byte) error {
	var res AAAFailureTokenRefresh
