...
func (m *DocPolicies) validateList(formats strfmt.Registry) error {
...
func (m *DocPolicies) validateNext(formats strfmt.Registry) error {
...
func (m *DocPolicies) validateSummaryByState(formats strfmt.Registry) error {
...
func (m *DocPolicies) contextValidateList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DocPolicies) contextValidateNext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DocPolicies) contextValidateSummaryByState(ctx context.Context, formats strfmt.Registry) error {
