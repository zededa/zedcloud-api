...
func (m *Credentials) validateList(formats strfmt.Registry) error {
...
func (m *Credentials) validateNext(formats strfmt.Registry) error {
...
func (m *Credentials) validateSummaryByState(formats strfmt.Registry) error {
...
func (m *Credentials) contextValidateList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Credentials) contextValidateNext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Credentials) contextValidateSummaryByState(ctx context.Context, formats strfmt.Registry) error {
