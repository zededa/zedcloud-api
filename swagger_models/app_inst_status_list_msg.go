...
func (m *AppInstStatusListMsg) validateList(formats strfmt.Registry) error {
...
func (m *AppInstStatusListMsg) validateNext(formats strfmt.Registry) error {
...
func (m *AppInstStatusListMsg) contextValidateList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppInstStatusListMsg) contextValidateNext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppInstStatusListMsg) contextValidateSummaryByState(ctx context.Context, formats strfmt.Registry) error {
