...
func (m *Enterprises) validateList(formats strfmt.Registry) error {
...
func (m *Enterprises) validateNext(formats strfmt.Registry) error {
...
func (m *Enterprises) validateSummaryByState(formats strfmt.Registry) error {
...
func (m *Enterprises) contextValidateList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Enterprises) contextValidateNext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Enterprises) contextValidateSummaryByState(ctx context.Context, formats strfmt.Registry) error {
