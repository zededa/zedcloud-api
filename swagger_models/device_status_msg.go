...
func (m *DeviceStatusMsg) validateZpoolMetrics(formats strfmt.Registry) error {
...
func (m *DeviceStatusMsg) contextValidateZpoolMetrics(ctx context.Context, formats strfmt.Registry) error {
