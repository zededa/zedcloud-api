...
func (m *IntegrationPolicy) validateRevision(formats strfmt.Registry) error {
...
func (m *IntegrationPolicy) contextValidateRevision(ctx context.Context, formats strfmt.Registry) error {
